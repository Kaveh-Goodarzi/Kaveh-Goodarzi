...
I’m a **junior software developer** on the path toward **software engineering**.
I focus on building strong fundamentals, learning in public, and improving step by step.

This profile is not about showing off — it’s about **showing progress**.

---

## Core Skills

These are the tools I actively use and feel comfortable with:
...
* **Go** — main language (backend-focused)
* **Web fundamentals** — HTML, CSS, JavaScript
* **Python** — scripting & general programming
* **Linux** — daily usage, CLI-oriented

---

## Currently Learning

Things I am actively studying and practicing:

<div align="center">

<img src="https://skillicons.dev/icons?i=docker,postgres,nginx&perline=6" />

</div>

* Backend architecture & clean code
* Databases and data modeling
* Networking fundamentals (theory → practice)
...
* Web technologies
* Linux & open-source
* Security mindset (ethical, beginner level)
